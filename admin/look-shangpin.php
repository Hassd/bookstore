      ...
      <tr>
        <td  bgcolor="#666666"><table width="670" cellspacing="1" border="0px">
            <tr>
              ...
              <td width="77"  bgcolor="#FFFFFF"><div>是否推荐</div></td>
               <td width="77"  bgcolor="#FFFFFF"><div>图书预售</div></td>
    ...
    ?>
            <tr>
              ...
              <td bgcolor="#FFFFFF" style="text-align:center;">
								<a href="xg-shangpin.php?id=<?php echo $row['bookid']; ?>">修改</a>&nbsp;
								<a href= "del-book.php?id=<?php echo $row['bookid']; ?>">删除</a></td>
            </tr>
       <?php
	   }	}?>  
          </table></td>
