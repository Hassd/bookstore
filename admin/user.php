...
<div id="right" >
  ...
  <form action="all-del-user.php" method="get" >
	...
	$query="select * from tb_user limit $start,$pagesize";
	$result=mysqli_query($link,$query);
    ...
    ?>
			<tr>
				<td bgcolor="#FFFFFF" style="text-align:center;">
					<input type="checkbox" name="<?php echo $row['userid']; ?>" value="1" />
				</td>
				<td bgcolor="#FFFFFF"style="text-align:center;"><?php echo $row['username'];?></td>
				<td bgcolor="#FFFFFF"style="text-align:center;"><?php echo $row['password'];?></td>
				<td bgcolor="#FFFFFF"style="text-align:center;"><?php echo $row['adress'];?></td>
				<td bgcolor="#FFFFFF"style="text-align:center;"><?php echo $row['tel'];?></td>
				<td bgcolor="#FFFFFF"style="text-align:center;"><?php echo $row['email'];?></td>
				<td bgcolor="#FFFFFF"style="text-align:center;"><?php echo $row['redtime'];?></td>

				<td bgcolor="#FFFFFF" style="text-align:center;">
					<a href= "del-user.php?id=<?php echo $row['userid']; ?>">删除</a>
				</td>
			</tr>
       <?php
	   }	}?>  
