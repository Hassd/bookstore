...
<div id="content">
  ...
  <?php
    ...
    //查询
    if($select=='bookname'){
        $query="select * from tb_book where bookname like '%$text%'";
    }else{
        $query="select * from tb_book where author like '%$text%'";
    }
    ...
    $qwe=($page-1)*$pagesize;
    if($select=='bookname'){
        $query1="select * from tb_book where bookname like '%$text%' limit $qwe,$pagesize";
    }else{
        $query1="select * from tb_book where author like '%$text%' limit $qwe,$pagesize";
    }
  ...
  ?>   
    ...
    <a href="search.php?select=<?php echo $select?>&text=<?php echo $text?>">第一页</a>
    
    <a href="search.php?select=<?php echo $select?>&text=<?php echo $text?>&page=<?php echo $page-1?>" 
    ...
    <a href="search.php?select=<?php echo $select?>&text=<?php echo $text?>&page=<?php echo $total?>">尾页</a>&nbsp;
